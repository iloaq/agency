...
/* Зеркально к comes-in-goes-out. https://www.fancycomponents.dev/docs/components/text/underline-animation */
/* GSAP: https://gsap.com/docs/v3/GSAP/CorePlugins/CSS/ */

export type GoesOutComesInDirection = "left" | "right";
...
export type GoesOutComesInUnderlineProps = {
  children: ReactNode;
  className?: string;
  direction?: GoesOutComesInDirection;
...
export default function GoesOutComesInUnderline({
  ...
  const enterOrigin = direction === "left" ? "100% 50%" : "0% 50%";
  const exitOrigin = direction === "left" ? "0% 50%" : "100% 50%";
